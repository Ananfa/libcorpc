...
const ::google::protobuf::ServiceDescriptor* HelloWorldService_descriptor_ = NULL;
...
void protobuf_AssignDesc_helloworld_2eproto() {
  ...
  static const int FooRequest_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FooRequest, msg1_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FooRequest, msg2_),
  };
  ...
  static const int FooResponse_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FooResponse, msg_),
  };
  FooResponse_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(FooResponse));
  HelloWorldService_descriptor_ = file->service(0);
}
...
#ifndef _MSC_VER
const int FooRequest::kMsg1FieldNumber;
const int FooRequest::kMsg2FieldNumber;
#endif  // !_MSC_VER
      ...
      case 1: {
        if (tag == 10) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_msg1()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->msg1().data(), this->msg1().length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "msg1");
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(18)) goto parse_msg2;
        break;
      }
      ...
      case 2: {
        if (tag == 18) {
         parse_msg2:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->msg2().data(), this->msg2().length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "msg2");
        } else {
          goto handle_unusual;
...
#ifndef _MSC_VER
const int FooResponse::kMsgFieldNumber;
#endif  // !_MSC_VER
...
const ::google::protobuf::ServiceDescriptor* HelloWorldService::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return HelloWorldService_descriptor_;
}

const ::google::protobuf::ServiceDescriptor* HelloWorldService::GetDescriptor() {
  protobuf_AssignDescriptorsOnce();
  return HelloWorldService_descriptor_;
}

void HelloWorldService::foo(::google::protobuf::RpcController* controller,
                         const ::FooRequest*,
                         ::FooResponse*,
...
void HelloWorldService::CallMethod(const ::google::protobuf::MethodDescriptor* method,
                             ::google::protobuf::RpcController* controller,
                             const ::google::protobuf::Message* request,
                             ::google::protobuf::Message* response,
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), HelloWorldService_descriptor_);
  switch(method->index()) {
    case 0:
      foo(controller,
...
const ::google::protobuf::Message& HelloWorldService::GetRequestPrototype(
...
const ::google::protobuf::Message& HelloWorldService::GetResponsePrototype(
    const ::google::protobuf::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
HelloWorldService_Stub::HelloWorldService_Stub(::google::protobuf::RpcChannel* channel)
...
void HelloWorldService_Stub::foo(::google::protobuf::RpcController* controller,
