...
class QuxRequest final :
 ...
 public:
  ...
  ~QuxRequest() override;
  explicit constexpr QuxRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class QuxResponse final :
 ...
 public:
  ...
  ~QuxResponse() override;
  explicit constexpr QuxResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void QuxRequest::set_text(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void QuxResponse::set_text(ArgT0&& arg0, ArgT... args) {
